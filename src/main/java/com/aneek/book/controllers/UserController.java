...
public class UserController {
	...
	@PutMapping("/update/{userId}") // is called path URI variable  
	public ResponseEntity<UserDto> updateUser(@RequestBody  UserDto userDto, @PathVariable Integer userId) // user details will received with the help of @Requestbody
